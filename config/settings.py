...
from utils.constants import ThrottleScope, Constants
...
SECRET_KEY = 'django-insecure-i=w)%(ub+ezszhxn4axh=tc@pjc7ag84_(@u8qlo-8=$w)ew6^'
...
DATABASES = {
    ...
    'test': {  # this is shit, just for dbrestore command
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'test',
        'USER': os.getenv('POSTGRES_USER'),
        'PASSWORD': os.getenv('POSTGRES_PASSWORD'),
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': ThrottleScope.as_settings_from_env(Constants.THROTTLE_RATE),
}
# ============= Django Rest Framework Settings =============
